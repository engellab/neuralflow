...
Nonstationary data distribution can be modeled by inferring initial distribution of the latent states and 
...
Viterbi algorithm for inferring the most probable path is also included.
...
For more information, see Genkin and Engel (2020) [#Genkin2020]_, Genkin, Hughes and Engel (2020) [#Genkin2021]_,
